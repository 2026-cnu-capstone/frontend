...
export default function MetaBlock({ path, check }: Props) {
  ...
  return (
    <div className="mt-2.5 bg-f-bg border border-f-border rounded-[6px] px-3 py-2.5">
      <div className="text-[9.5px] font-semibold tracking-[0.12em] uppercase text-f-t4 mb-2">
        디스크 이미지 메타데이터
      </div>
